...
style.code_font = renderer.font.group {
  renderer.font.load("/usr/share/fonts/TTF/JetBrainsMono-Regular.ttf", 22 * SCALE)
}

style.font = renderer.font.group {
  renderer.font.load("/usr/share/fonts/TTF/JetBrainsMono-Regular.ttf", 16 * SCALE)
}

lintplus.load({"go_linter", "luacheck"})
